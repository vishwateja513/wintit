...
import { Building2, Users, FileText, BarChart3, Settings, LogOut, User, Menu, X, Wifi, WifiOff, Home } from 'lucide-react'
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center cursor-pointer" onClick={() => onTabChange('dashboard')}>
              ...
              <h1 className="ml-2 text-lg lg:text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">
                Retail Audit
              </h1>
      ...
      <div className="flex">
        {/* Left Sidebar */}
        <nav className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white shadow-sm border-r border-gray-200 transform transition-transform duration-300 ease-in-out ${
      ...
      {/* Mobile Bottom Padding - Only on very small screens */}
