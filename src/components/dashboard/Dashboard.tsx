  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Welcome back! Here's your retail execution overview</p>
      </div>
                ...
                {recentAudits.map((audit) => (
                  <div key={audit.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900">{audit.storeName}</h4>
                  ...
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{store.score}% compliance</p>
                      </div>
                    </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="flex items-center justify-center p-4 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors">
                ...
                <span className="text-blue-600 font-medium">Create Template</span>
              </button>
              <button className="flex items-center justify-center p-4 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <span className="text-green-600 font-medium">Start Audit</span>
              </button>
