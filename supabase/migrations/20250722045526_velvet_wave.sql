/*
  ...
  1. New Tables
    ...
    - `audit_templates` - Main template definitions  
...
-- Create template_categories table (matches existing schema)
...
-- Create audit_templates table (matches existing schema)
...
-- Create trigger for updated_at on audit_templates
